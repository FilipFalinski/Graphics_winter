...
public class Pipeline : MonoBehaviour
{
    ...
    {
        List<Vector2Int> screenCords = new List<Vector2Int>();
        foreach (Vector3 v in imageAfterProjection)
        {
            Vector2Int screenCord = Convert(DivideByZ(v));
            screenCords.Add(screenCord);
        }
    ...
    {
        Matrix4x4 everythingMatrix = transformMatrix * viewingMatrix * projectionMatrix;
    ...
    private void CalculateProjectionMatrix()
    {
        ...
        projectionMatrix = Matrix4x4.Perspective(90, 1, 1, 1000);
    ...
    private List<Vector3> GetImageAfter(List<Vector3> vertices, Matrix4x4 transformationMatrix)
    {
            ...
            foreach (Vector3 v in vertices)
        {
            ...
            Debug.LogError("Vertices list is null in GetImageAfter method.");
        }
